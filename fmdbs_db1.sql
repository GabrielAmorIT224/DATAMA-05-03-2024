...
(1, 'Meeting Room', 'DATAMA1\\Images\\facility_1.png\r\n', 'Your text goes here'),
(2, 'Conference Room', 'DATAMA1\\Images\\facility_2.png', 'DATAMA\\Images\\facility_3.png'),
(3, 'Banquet Hall', 'DATAMA1\\Images\\facility_3.png', NULL);
...
INSERT INTO `tbl_reservation` (`RESERVATION_ID`, `FACILITY_ID`, `USER_ID`, `RESERVATION_DATE`, `STATUS_ID`) VALUES
(0, 1, 1, '2024-03-06', 1);
...
(1, 'Richard Gabriel', 'Espaldon', 'Amor', '2004-01-22', 20, 'Caloocan City', '176', 'Langit Road', 'richardgabrielamor@gmail.com', '09334649776', '$2y$10$uH9F.9aJjtJYv3bGfZlNF.FjDG5k0WNbcLXVyxtQKIDzFrrDDxiDO');
