...
<div class="header">
    ...
    <a href="user_information.php" class="btn btn-settings" target="_blank">Settings</a>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    ...
                    <img src="http://localhost/<?php echo $rowFacility['IMAGE_URL']; ?>" class="card-img-top" alt="Facility Image" style="width: 100%; height: auto; border-radius: 10px; border: 2px solid black;">                    </div>
